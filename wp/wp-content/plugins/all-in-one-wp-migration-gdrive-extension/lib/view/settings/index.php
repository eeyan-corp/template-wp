		...
		<div class="ai1wm-left">
			<div class="ai1wm-holder" id="ai1wmge-gdrive-connect">
				...
				<div class="ai1wm-field">
					<?php if ( $token ) : ?>
						...
						<form method="post" action="<?php echo esc_url( wp_nonce_url( admin_url( 'admin-post.php?action=ai1wmge_gdrive_revoke' ), 'ai1wmge_gdrive_revoke' ) ); ?>">
			...
			<?php if ( $token ) : ?>
				<div id="ai1wmge-backups" class="ai1wm-holder">
					...
					<form method="post" action="<?php echo esc_url( wp_nonce_url( admin_url( 'admin-post.php?action=ai1wmge_gdrive_settings' ), 'ai1wmge_gdrive_settings' ) ); ?>">
